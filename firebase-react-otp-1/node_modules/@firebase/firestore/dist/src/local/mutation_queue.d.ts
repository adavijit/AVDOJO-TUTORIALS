...
export interface MutationQueue {
     ...
     */
    acknowledgeBatch(transaction: PersistenceTransaction, batch: MutationBatch, streamToken: ByteString): PersistencePromise<void>;
    /** Returns the current stream token for this mutation queue. */
    getLastStreamToken(transaction: PersistenceTransaction): PersistencePromise<ByteString>;
    /** Sets the stream token for this mutation queue. */
    setLastStreamToken(transaction: PersistenceTransaction, streamToken: ByteString): PersistencePromise<void>;
    /**
